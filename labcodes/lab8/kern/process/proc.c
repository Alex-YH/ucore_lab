...
alloc_proc(void) {
	...
	if (proc != NULL) {
		...
		//LAB5 2012013320 : (update LAB4 steps)
		/*
		...
		//LAB6 2012013320 : (update LAB5 steps)
		/*
		...
		proc->lab6_stride = 0;
		//LAB8:2012013320 YOUR CODE HINT:need add some code to init fs in proc_struct, ...
		proc -> filesp = NULL;
	}
	return proc;
}
...
int do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
	...
	ret = -E_NO_MEM;
	//LAB4:EXERCISE2 2012013320
	//LAB8:EXERCISE2 2012013320  HINT:how to copy the fs in parent's proc_struct?
	/*
...
static int load_icode(int fd, int argc, char **kargv) {
	/* LAB8:2012013320 YOUR CODE  HINT:how to load the file with handler fd  in to process's memory? how to setup argc/argv?
	 * MACROs or Functions:
